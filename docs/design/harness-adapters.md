...
Amends: `docs/design/engine-extraction.md` §2 (what `PaneHost` hands back) and
`docs/design/remote-engine-protocol.md` §4 (two additive events, one roster
field). Amended by #2850/#2891: six additive `HarnessEvent` variants (§1.2),
extension-UI dialogs (§3.5), and §5's two projections. Reads on: `docs/design/opencode.md` (how a harness is driven today),
`docs/design/session-id-learning.md` (#440), `docs/design/human-questions.md`
(#946), `docs/design/needs-you-items.md` (#1151),
`docs/design/group-cost-tracking.md` (#42), `docs/design/workflows.md` (#222).
...
`docs/design/pi.md`'s "RPC driver (#2850)" section carries the wire facts and
...
(`docs/design/pi.md`, "RPC driver (#2850)"). These surface as
