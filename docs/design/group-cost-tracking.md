...
panes actually running. See docs/design/polled-payload-shapes.md §1. Each total's `*_cost_basis`
...
published snapshot instead (`docs/design/polled-views.md`). That computation reads *every live agent's* transcript.
