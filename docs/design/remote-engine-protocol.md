...
build plan on #888 itself, `docs/design/groupid-and-path-roots.md` (#904, layer 2
of this model, landed), `docs/design/engine-transport.md` (#905, the client-side
cut line, landed), `docs/design/pty-output-coalescing.md` (#712/#714),
`docs/design/performance.md` (the invariants this transport must not quietly
escape), `docs/design/lock-resources.md` (#858) and `docs/design/ssh-panes.md`
...
See `docs/design/remote-engine-daemon.md` §3 for the full argument.
...
log instead, to a stated 32 MiB ceiling. See `docs/design/harness-adapters.md`.
...
|---|---|---|
| **agent session** | one agent CLI's own conversation | `list_sessions`, `session_id`, `resume_orch_session`, `docs/design/session-restore.md` — **unchanged by this note** |
...
- **Contention is a lock resource**, and here loomux already has exactly the
  ...
  `docs/design/lock-resources.md` is emphatic that an advisory lock described as
