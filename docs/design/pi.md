...
the one it is. Companion to `docs/design/orchestration.md` (the capability
model this plugs into), `docs/design/workflows.md` (how a block's persona
reaches a CLI at all) and `docs/design/opencode.md` (the precedent this note
...
project config (`docs/design/opencode.md` §Environment: loomux leaves the
...
picker, whose two sources (`docs/design/model-catalog.md`) are a curated
