...
`BoardPrefsStore` (`src/boardprefs.ts`, `docs/design/board-tree-view.md`
...
`loomux-server` daemon (`docs/design/remote-engine-daemon.md`) — against one
...
**Why a pane and not an overlay.** `docs/design/content-panes.md`'s "Why a pane
